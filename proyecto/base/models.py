...
class Tarea(models.Model):
    ...
    titulo = models.CharField(_('Título'), max_length=200)  # Título de la tarea
    descripcion = models.TextField(_('Descripción'),
                                   null=True,  # La descripción puede ser nula
                                   blank=True)  # El campo puede dejarse en blanco
    completo = models.BooleanField(_('Completo'),
                                   default=False)  # Estado de completitud de la tarea
